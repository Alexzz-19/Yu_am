...
- **Ámbito:** Exclusivamente la carpeta `/apps/web` (Next.js, React, Tailwind CSS).
- **Reglas:**
  ...
  3. No modifiques archivos fuera de la carpeta `apps/web/`.
...
- **Regla estricta:** Si falta una clave visual o de Supabase, solicita actualizar únicamente `apps/web/.env.local`. Nunca pidas credenciales del Backend.
